"""Compliance tests for 10918 Process 1."""
...
# Process 1 compliance directory
...
class TestJPEGProcess01_Parse(object):
    """JPEG 10918-2 compliance tests for parsing Process 1.
    ...
    def test_all_required_markers_found(self):
        ...
        optional_keys = ['RST0', 'RST1', 'RST2', 'RST3', 'RST4', 'RST5',
                         ...
                         'APP13', 'APP14', 'APP15']
        for info in [parse_jpg(open(PROCESS01_A1, 'rb')),  parse_jpg(open(PROCESS01_B2, 'rb'))]:
